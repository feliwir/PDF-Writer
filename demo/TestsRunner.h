...
class TestsRunner
{
  public:
    ...
    PDFHummus::EStatusCode RunExcludeCategories(const TestConfiguration &inTestConfiguration,
  ...
  private:
    ...
    PDFHummus::EStatusCode RunTestsInList(const TestConfiguration &inTestConfiguration,
                                          const StringAndTestUnitList &inTests);
    PDFHummus::EStatusCode RunSingleTest(const TestConfiguration &inTestConfiguration, const string &inTestName,
                                         ITestUnit *inTest);
    void DeleteTests();
};
...
#define ADD_TEST(X)                                                                                                    \
    template <class T> class TestRegistrar                                                                             \
    {                                                                                                                  \
      public:                                                                                                          \
        TestRegistrar()                                                                                                \
        {                                                                                                              \
