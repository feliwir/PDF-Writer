...
EStatusCode TextUsageBugs::RunKoreanFontTest(const TestConfiguration &inTestConfiguration)
{
    ...
    do
    {
        status = pdfWriter.StartPDF(
            RelativeURLToLocalPath(inTestConfiguration.mSampleFileBase, "KoreanFontTest.pdf"), ePDFVersion13,
        ...
        cxt->WriteText(10, 400,
                       "\x48\x65\x6C\x6C\x6F\x20\x57\x6F\x72\x6C\x64\x20\xED\x95\x9C\xEA\xB8\x80\x20\x61\x62\x63\x21",
                       textOptions);
...
EStatusCode TextUsageBugs::RunCNRSTest(const TestConfiguration &inTestConfiguration)
{
    ...
    {
        status = pdfWriter.StartPDF(
            RelativeURLToLocalPath(inTestConfiguration.mSampleFileBase, "TextUsageBugsCNRS.pdf"), ePDFVersion14,
...
EStatusCode TextUsageBugs::RunCNRS2SampleTest(const TestConfiguration &inTestConfiguration)
{
    ...
    {
        status = pdfWriter.StartPDF(
            RelativeURLToLocalPath(inTestConfiguration.mSampleFileBase, "TextUsageBugsCNRSSample.pdf"), ePDFVersion14);
        if (status != PDFHummus::eSuccess)
        {
            cout << "failed to start PDF\n";
            break;
...
EStatusCode TextUsageBugs::RunCNRS2Test(const TestConfiguration &inTestConfiguration)
{
    ...
    {
        status = pdfWriter.StartPDF(
            RelativeURLToLocalPath(inTestConfiguration.mSampleFileBase, "TextUsageBugsCNRSFinal.pdf"), ePDFVersion14);
        if (status != PDFHummus::eSuccess)
        {
            cout << "failed to start PDF\n";
            break;
