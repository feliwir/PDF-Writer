...
EStatusCode ImagesAndFormsForwardReferenceTest::Run(const TestConfiguration &inTestConfiguration)
{
    ...
    do
    {
        ...
        status = pdfWriter.StartPDF(
            RelativeURLToLocalPath(inTestConfiguration.mSampleFileBase, "ImagesAndFormsForwardReferenceTest.pdf"),
            ePDFVersion13);
        ...
        pageContentContext->q();
        ObjectIDType tiffFormXObjectID =
        ...
        ObjectIDType simpleFormXObjectID =
            pdfWriter.GetObjectsContext().GetInDirectObjectsRegistry().AllocateNewObjectID();
