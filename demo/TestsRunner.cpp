...
EStatusCode TestsRunner::RunTestsInList(const TestConfiguration &inTestConfiguration,
...
EStatusCode TestsRunner::RunSingleTest(const TestConfiguration &inTestConfiguration, const string &inTestName,
                                       ITestUnit *inTest)
{
    EStatusCode testStatus;
...
EStatusCode TestsRunner::RunExcludeCategories(const TestConfiguration &inTestConfiguration,
