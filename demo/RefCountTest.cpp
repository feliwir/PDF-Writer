...
EStatusCode RefCountTest::Run(const TestConfiguration &inTestConfiguration)
{
    ...
    // 2 refs to direct object
    {
        ...
        if (MyClass::TotalObjectsCount != 1)
        {
            cout << "Total objects count is supposed to be 1 after creating object 2, but it's "
                 << MyClass::TotalObjectsCount << "\n";
            status = PDFHummus::eFailure;
        }
        ...
        if (MyClass::TotalObjectsCount != 1)
        {
            cout << "Total objects count is supposed to be 1 after another pointer for object 2, but it's "
                 << MyClass::TotalObjectsCount << "\n";
            status = PDFHummus::eFailure;
        }
    }
    ...
    // assignment scenarios
    {
        ...
        if (MyClass::TotalObjectsCount != 1)
        {
            cout << "Total objects count is supposed to be 1 after creating object 3, but it's "
                 << MyClass::TotalObjectsCount << "\n";
            status = PDFHummus::eFailure;
        }
        if (firstPtr->GetID() != 3)
        ...
        if (MyClass::TotalObjectsCount != 1)
        {
            cout << "Total objects count is supposed to be 1 after smart pointer assignment object 3, but it's "
                 << MyClass::TotalObjectsCount << "\n";
            status = PDFHummus::eFailure;
        }
        ...
        if (MyClass::TotalObjectsCount != 1)
        {
            cout << "Total objects count is supposed to be 1 after pointer assignment object 3, but it's "
                 << MyClass::TotalObjectsCount << "\n";
            status = PDFHummus::eFailure;
        }
    }
