...
{
    cout << "Usage:\n"
         << "PDFWriterTestPlayground -b BasePath [-c category1 category2... [-xt test1 test2...]] [-t test1 test2...] "
            "[-xc category1 category2...] [-xt test1 test2...]\n\n"
         << "PDFWriterTestPlayground runs tests.\n"
         << "Use -b to designate the base testing folder. it should be in the lingua of the OS. for example, to use "
            "C:\\PDFLibTests on windows go \"-b c:\\PDFLibTests\"\n."
         << "If no options are selected, the application will run all tests.\n\n"
         << "Use -c to run only a group of tests assigned to specific categories. after -c name the cateogries. for "
            "example:\n"
         ...
         << "Use -xc to all but the group of tests assigned to specific categories. after -xc name the cateogries. for "
            "example:\n"
         << "	PDFWriterTestPlayGround -xc PDF ObjectContext\n"
         << "Use -xt to run all but a group of tests named by the next parameters. after -xt name the tests. for "
            "example:\n"
         << "	PDFWriterTestPlayGround -t PDFDateTest PDFTextStingTest\n"
         << "it is possible to use -xt after -c directive to filter particular tests for the executed categories. for "
            "example:\n"
