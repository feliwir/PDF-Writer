...
typedef std::pair<charta::EStatusCode, PDFFormXObjectList> EStatusCodeAndPDFFormXObjectList;

typedef std::list<ObjectIDType> ObjectIDTypeList;
typedef std::pair<charta::EStatusCode, ObjectIDTypeList> EStatusCodeAndObjectIDTypeList;
