...
#define SAFE_SPRINTF_3(BUFFER, BUFFER_SIZE, FORMAT, ARG1, ARG2, ARG3)                                                  \
    sprintf_s(BUFFER, BUFFER_SIZE, FORMAT, ARG1, ARG2, ARG3)
#define SAFE_SPRINTF_4(BUFFER, BUFFER_SIZE, FORMAT, ARG1, ARG2, ARG3, ARG4)                                            \
    sprintf_s(BUFFER, BUFFER_SIZE, FORMAT, ARG1, ARG2, ARG3, ARG4)
#define SAFE_SPRINTF_5(BUFFER, BUFFER_SIZE, FORMAT, ARG1, ARG2, ARG3, ARG4, ARG5)                                      \
    sprintf_s(BUFFER, BUFFER_SIZE, FORMAT, ARG1, ARG2, ARG3, ARG4, ARG5)
#define SAFE_SPRINTF_6(BUFFER, BUFFER_SIZE, FORMAT, ARG1, ARG2, ARG3, ARG4, ARG5, ARG6)                                \
    sprintf_s(BUFFER, BUFFER_SIZE, FORMAT, ARG1, ARG2, ARG3, ARG4, ARG5, ARG6)
...
#define SAFE_SWPRINTF_3(BUFFER, BUFFER_SIZE, FORMAT, ARG1, ARG2, ARG3)                                                 \
    swprintf_s(BUFFER, BUFFER_SIZE, FORMAT, ARG1, ARG2, ARG3)
#define SAFE_SWPRINTF_4(BUFFER, BUFFER_SIZE, FORMAT, ARG1, ARG2, ARG3, ARG4)                                           \
    swprintf_s(BUFFER, BUFFER_SIZE, FORMAT, ARG1, ARG2, ARG3, ARG4)
#define SAFE_SWPRINTF_5(BUFFER, BUFFER_SIZE, FORMAT, ARG1, ARG2, ARG3, ARG4, ARG5)                                     \
    swprintf_s(BUFFER, BUFFER_SIZE, FORMAT, ARG1, ARG2, ARG3, ARG4, ARG5)
#define SAFE_SWPRINTF_6(BUFFER, BUFFER_SIZE, FORMAT, ARG1, ARG2, ARG3, ARG4, ARG5, ARG6)                               \
    swprintf_s(BUFFER, BUFFER_SIZE, FORMAT, ARG1, ARG2, ARG3, ARG4, ARG5, ARG6)
#ifdef __MINGW32__
...
#define SAFE_FOPEN(FILESTREAM_P, FILE_PATH, MODE)                                                                      \
    {                                                                                                                  \
        FILESTREAM_P = _wfsopen(UTF8ToUTF16Wide(FILE_PATH).c_str(), UTF8ToUTF16Wide(MODE).c_str(), _SH_DENYNO);        \
    }
...
#define SAFE_SWPRINTF_4(BUFFER, BUFFER_SIZE, FORMAT, ARG1, ARG2, ARG3, ARG4)                                           \
    swprintf(BUFFER, FORMAT, ARG1, ARG2, ARG3, ARG4)
#define SAFE_SWPRINTF_5(BUFFER, BUFFER_SIZE, FORMAT, ARG1, ARG2, ARG3, ARG4, ARG5)                                     \
    swprintf(BUFFER, FORMAT, ARG1, ARG2, ARG3, ARG4, ARG5)
#define SAFE_SWPRINTF_6(BUFFER, BUFFER_SIZE, FORMAT, ARG1, ARG2, ARG3, ARG4, ARG5, ARG6)                               \
    swprintf(BUFFER, FORMAT, ARG1, ARG2, ARG3, ARG4, ARG5, ARG6)
#define SAFE_LOCAL_TIME(structuredLocalTime, currentTime) structuredLocalTime = *localtime(&currentTime)
...
#define SAFE_FOPEN(FILESTREAM_P, FILE_PATH, MODE)                                                                      \
    {                                                                                                                  \
        FILESTREAM_P = fopen(FILE_PATH, MODE);                                                                         \
    }
#define SAFE_SGETN(BUFFER, BUFFER_SIZE, READ_COUNT) sgetn(BUFFER, READ_COUNT)
