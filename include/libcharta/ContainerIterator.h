...
template <class T> class ContainerTraits<const T>
{
  public:
...
template <class T> ContainerIterator<T>::ContainerIterator(T &inList)
{
...
template <class T> ContainerIterator<T>::ContainerIterator(const ContainerIterator<T> &inOtherIterator)
{
...
template <class T> bool ContainerIterator<T>::MoveNext()
{
...
template <class T> bool ContainerIterator<T>::IsFinished()
{
