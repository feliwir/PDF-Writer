...
class EncryptionHelper
{
  ...
  public:
    ...
    /*
        Initial step. starts (or not) encryption. note that you need file ID here, so you need to compute it before
       calling this method. will return status ok always. if you want to know whether ecnryption is actually supported
