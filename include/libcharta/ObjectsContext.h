...
class ObjectsContext
{
  public:
    ...
    void WriteIndirectObjectReference(ObjectIDType inIndirectObjectID, unsigned long inGenerationNumber,
                                      ETokenSeparator inSeparate = eTokenSeparatorSpace);
    void WriteIndirectObjectReference(const ObjectReference &inObjectReference,
                                      ETokenSeparator inSeparate = eTokenSeparatorSpace);
    void WriteNewIndirectObjectReference(ObjectIDType indirectObjectID,
                                         ETokenSeparator inSeparate = eTokenSeparatorSpace);
