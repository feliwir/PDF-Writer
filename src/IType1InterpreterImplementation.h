...
class IType1InterpreterImplementation
{
  public:
    ...
    virtual PDFHummus::EStatusCode CallOtherSubr(const LongList &inOperandList,
                                                 LongList &outPostScriptOperandStack) = 0;
    virtual PDFHummus::EStatusCode Type1Pop(const LongList &inOperandList,
                                            const LongList &inPostScriptOperandStack) = 0;
