...
template <class T> class SingleValueContainerIterator : public ContainerIterator<T>
{
  public:
...
template <class T>
SingleValueContainerIterator<T>::SingleValueContainerIterator(const SingleValueContainerIterator<T> &inOtherIterator)
    : ContainerIterator<T>(inOtherIterator)
{
}

template <class T> typename T::value_type SingleValueContainerIterator<T>::GetItem()
{
