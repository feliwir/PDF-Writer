...
typedef std::map<ResourcesDictionaryAndString, IResourceWritingTaskList>
    ResourcesDictionaryAndStringToIResourceWritingTaskListMap;
...
typedef std::map<PDFTiledPattern *, ITiledPatternEndWritingTaskList>
    PDFTiledPatternToITiledPatternEndWritingTaskListMap;
...
class DocumentContext
{
  public:
    ...
    // WritePage and WritePageAndRelease)
    ...
    PDFTiledPattern *StartTiledPattern(int inPaintType, int inTilingType, const PDFRectangle &inBoundingBox,
                                       double inXStep, double inYStep, const double *inMatrix = NULL);
    PDFTiledPattern *StartTiledPattern(int inPaintType, int inTilingType, const PDFRectangle &inBoundingBox,
    ...
    // IDs to place the created form xobjects (note that you can provide your own as the inPredefinedFormIds...just make
    // sure the list is same size as pages list)
    ...
    EStatusCodeAndObjectIDTypeList CreateFormXObjectsFromPDF(
        ...
        const PDFPageRange &inPageRange, EPDFPageBox inPageBoxToUseAsFormBox,
    ...
    EStatusCodeAndObjectIDTypeList CreateFormXObjectsFromPDF(
        const std::string &inPDFFilePath, const PDFParsingOptions &inParsingOptions, const PDFPageRange &inPageRange,
        const PDFRectangle &inCropBox, const double *inTransformationMatrix = NULL,
        const ObjectIDTypeList &inCopyAdditionalObjects = ObjectIDTypeList(),
        const ObjectIDTypeList &inPredefinedFormIDs = ObjectIDTypeList());

    EStatusCodeAndObjectIDTypeList CreateFormXObjectsFromPDF(
        IByteReaderWithPosition *inPDFStream, const PDFParsingOptions &inParsingOptions,
        const PDFPageRange &inPageRange, const PDFRectangle &inCropBox, const double *inTransformationMatrix = NULL,
        const ObjectIDTypeList &inCopyAdditionalObjects = ObjectIDTypeList(),
        const ObjectIDTypeList &inPredefinedFormIDs = ObjectIDTypeList());
    ...
    EStatusCodeAndObjectIDTypeList AppendPDFPagesFromPDF(
        IByteReaderWithPosition *inPDFStream, const PDFParsingOptions &inParsingOptions,
        const PDFPageRange &inPageRange, const ObjectIDTypeList &inCopyAdditionalObjects = ObjectIDTypeList());
    ...
    EStatusCode WriteFormForImage(
        const std::string &inImagePath, unsigned long inImageIndex, ObjectIDType inObjectID,
  ...
  private:
    ...
    void WriteReferenceState(ObjectsContext *inStateWriter, const ObjectReference &inReference);
