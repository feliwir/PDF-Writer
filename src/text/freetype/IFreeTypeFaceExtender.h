...
class IFreeTypeFaceExtender
{
  public:
    ...
    // CapHeight - bool should indicate whether the 2nd value is valid. this will indicate container to go look for the
    // value by measuring the y value of H
    virtual BoolAndFTShort GetCapHeight() = 0;

    // XHeight - bool should indicae whether the 2nd value is valid. this will indicate container to go look for the
    // value by measuring the y value of x
