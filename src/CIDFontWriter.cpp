...
EStatusCode CIDFontWriter::WriteFont(FreeTypeFaceWrapper &inFontInfo, WrittenFontRepresentation *inFontOccurrence,
...
void CIDFontWriter::WriteGlyphEntry(charta::IByteWriter *inWriter, uint16_t inEncodedCharacter,
