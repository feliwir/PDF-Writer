...
class IPDFParserExtender
{
  public:
    ...
    virtual IByteReader *CreateFilterForStream(IByteReader *inStream, PDFName *inFilterName,
                                               PDFDictionary *inDecodeParams, PDFStreamInput *inPDFStream) = 0;
    ...
    virtual IByteReader *CreateDefaultDecryptionFilterForStream(PDFStreamInput *inStream,
