...
class PDFCommentWriter
{
  public:
    ...
    charta::EStatusCode AttachCommentTreeToNextPage(PDFComment *inComment,
    ...
    charta::EStatusCode WriteCommentTree(PDFComment *inComment,
                                         std::map<PDFComment *, ObjectIDType> &ioPageCommentsContext);
  ...
  private:
    ...
    std::pair<charta::EStatusCode, ObjectIDType> WriteCommentsTree(
